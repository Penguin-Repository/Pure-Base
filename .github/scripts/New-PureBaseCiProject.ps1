...
if ([string]$shaderCoreJson.name -ne 'jp.lilxyzw.shadercore' -or [string]$shaderCoreJson.version -ne '0.1.12') {
  throw "The CI workspace requires jp.lilxyzw.shadercore exactly 0.1.12."
}
